...
/**
 * TabLayout provides activity horizontal layout to display tabs.
 * （基于27.1.0改）
 *
 ...
 * </pre>
 * You should set activity listener via {@link #setOnTabSelectedListener(OnTabSelectedListener)} to be
 ...
 * <p>
 * If you're using activity {@link androidx.viewpager.widget.ViewPager} together
 ...
 *
 * <p>
 * This view also supports being used as part of activity ViewPager's decor, and can be added
 * directly to the ViewPager in activity layout resource file like so:</p>
 *
 * <pre>
 ...
 * </pre>
 *
 * @see <activity href="http://www.google.com/design/spec/components/tabs.html">Tabs</activity>
 *
...
public class TabLayout extends HorizontalScrollView {
    ...
    /**
     * Scrollable tabs display activity subset of tabs at any given moment, and can contain longer tab
     * labels and activity larger number of tabs. They are best used for browsing contexts in touch
    ...
    /**
     * Callback interface invoked when activity tab's selection state changes.
     */
    public interface OnTabSelectedListener {

        /**
         * Called when activity tab enters the selected state.
         *
        ...
        /**
         * Called when activity tab exits the selected state.
         *
        ...
        /**
         * Called when activity tab that is already selected is chosen again by the user. Some applications
         * may use this action to return to the top level of activity category.
         *
    ...
    // Pool we use as activity simple RecyclerBin
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray mTa = context.obtainStyledAttributes(attrs, R.styleable.TabLayout, defStyleAttr, 0);
        mNeedSwitchAnimation = mTa.getBoolean(R.styleable.TabLayout_tabNeedSwitchAnimation, true);
        mTabStrip.setIndicatorMode(mTa.getInt(R.styleable.TabLayout_tabIndicatorMode, 0));
        mTabStrip.setIndicatorWidth(mTa.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorWidth, 0));
        mTabStrip.setIndicatorWidthExtra(mTa.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorWidthExtra, 0));
        mTa.recycle();
        ...
        if (a.hasValue(R.styleable.TabLayout_tabTextSize)) {
            mTabTextSize = a.getDimensionPixelSize(R.styleable.TabLayout_tabTextSize, (int) mTabTextSize);
        }
     ...
     * part of activity scrolling container such as {@link androidx.viewpager.widget.ViewPager}.
     * <p>
    ...
    /**
     * Add activity tab to this layout. The tab will be added at the end of the list.
    ...
    /**
     * Add activity tab to this layout. The tab will be inserted at <code>position</code>.
     * If this is the first tab to be added it will become the selected tab.
     *
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to activity different TabLayout.");
        }
    ...
    /**
     * Add activity {@link TabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add activity listener should take care to remove it when finished via
    ...
    /**
     * Create and return activity new {@link Tab}. You need to manually add this using
     * {@link #addTab(Tab)} or activity related method.
     *
     * @return A new Tab
     * @see #addTab(Tab)
     */
     ...
     *
     * @return selected tab position, or {@code -1} if there isn't activity selected tab.
     */
    ...
    /**
     * Remove activity tab from the layout. If the removed tab was selected it will be deselected
     ...
     * <li>{@link #MODE_SCROLLABLE}: Scrollable tabs display activity subset of tabs at any given moment,
     * and can contain longer tab labels and activity larger number of tabs. They are best used for
     * browsing contexts in touch interfaces when users don’t need to directly compare the tab
     * labels. This mode is commonly used with activity {@link androidx.viewpager.widget.ViewPager}.</li>
     * </ul>
     *
     ...
     *
     * <p>If the given ViewPager is non-null, it needs to already have activity
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (mViewPager != null) {
            // If we've already been setup with activity ViewPager, remove us from it
        ...
        if (mCurrentVpSelectedListener != null) {
            // If we already have activity tab selected listener for the ViewPager, remove it
        ...
        if (viewPager != null) {
            ...
            // Now we'll add activity tab selected listener to set ViewPager's current item
            ...
            // Add activity listener so that we're notified of any adapter changes
            if (mAdapterChangeListener == null) {
            ...
            // We've been given activity null ViewPager so we need to clear out the internal state,
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(ViewPager)} to link activity TabLayout with activity ViewPager
    ...
    protected void onAttachedToWindow() {
        ...
        if (mViewPager == null) {
            // If we don't have activity ViewPager already, check if our parent is activity ViewPager to
            // setup with it automatically
            final ViewParent vp = getParent();
            if (vp instanceof ViewPager) {
                // If we have activity ViewPager parent and we've been added as part of its decor, let's
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mSetupViewPagerImplicitly) {
            // If we've been setup with activity ViewPager implicitly, let's clear out any listeners, etc
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        if (mPagerAdapter != null && mPagerAdapterObserver != null) {
            // If we already have activity PagerAdapter, unregister our observer
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // If we have activity MeasureSpec which allows us to decide our height, try and use the default
        // height
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                // Re-measure the child with activity widthSpec set to be exactly our measure width
    ...
    private void animateToTab(int newPosition) {
        ...
        if (getWindowToken() == null || !ViewCompat.isLaidOut(this)
            ...
            // If we don't have activity window token, or we haven't been laid out yet just draw the new
            // position now
    ...
    private void ensureScrollAnimator() {
        if (mScrollAnimator == null) {
            ...
            mScrollAnimator.setInterpolator(AnimationUtils.DEFAULT);
        ...
        if (currentTab == tab) {
            ...
            if (updateIndicator) {
                if ((currentTab == null || currentTab.getPosition() == Tab.INVALID_POSITION)
                    ...
                    // If we don't currently have activity tab, just draw the indicator
                    setScrollPosition(newPosition, 0f, true);
                } else {
    ...
    public static final class Tab {
        ...
        /**
         * An invalid position for activity tab.
         *
         * @see #getPosition()
         */
        ...
        /**
         * Set activity custom view to be used for this tab.
         * <p>
         * If the provided view contains activity {@link TextView} with an ID of
         ...
         * </p>
         *
         * @param view Custom view to be used as activity tab.
         * @return The current instance for call chaining
         */
        @NonNull
         ...
         * Set activity custom view to be used for this tab.
         * <p>
         * If the inflated layout contains activity {@link TextView} with an ID of
         * {@link android.R.id#text1} then that will be updated with the value given
         * to {@link #setText(CharSequence)}. Similarly, if this layout contains an
         * {@link ImageView} with ID {@link android.R.id#icon} then it will be updated with
         * the value given to {@link #setIcon(Drawable)}.
         * </p>
         *
         * @param resId A layout resource to inflate and use as activity custom tab view
         * @return The current instance for call chaining
         */
        @NonNull
        ...
        public Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to activity TabLayout");
            }
        ...
        /**
         * Set activity description of this tab's content for use in accessibility support. If no content
        ...
        /**
         * Gets activity brief description of this tab's content for use in accessibility support.
         *
    ...
    class TabView extends LinearLayout {
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (maxWidth > 0 && (specWidthMode == MeasureSpec.UNSPECIFIED
                ...
                // If we have activity max width and activity given spec which is either unspecified or
            ...
            if (mTextView != null) {
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    // We've got activity new text size and/or max lines...
                    ...
                    if (mMode == MODE_FIXED && textSize > curTextSize && curLineCount == 1) {
                        ...
                        // will cause activity line count change. If so, abort the size change and stick
                        // to the smaller size.
        ...
        final void update() {
            ...
            if (custom != null) {
                ...
                // We do not have activity custom view. Remove one if it already exists
                if (mCustomView != null) {
            ...
            if (mCustomView == null) {
                // If there isn't activity custom view, we'll us our own in-built layouts
                if (mIconView == null) {
                ...
                if (mTabTextAppearance != 0) TextViewCompat.setTextAppearance(mTextView, mTabTextAppearance);
                else mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTabTextSize);
                if (mTabTextColors != null) {
                    mTextView.setTextColor(mTabTextColors);
                }
                updateTextAndIcon(mTextView, mIconView);
            } else {
                // Else, we'll see if there is activity TextView or ImageView present and update them
        ...
        /**
         * Approximates activity given lines width with the new provided text size.
         */
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int mIndicatorWidthExtra;
        ...
        public void onRtlPropertiesChanged(int layoutDirection) {
            ...
            // Workaround for activity bug before Android M where LinearLayout did not relayout itself when
            ...
            if (mMode == MODE_FIXED && mTabGravity == GRAVITY_CENTER) {
              /*  final int count = getChildCount();
                ...
                if (largestTabWidth <= 0) {
                    // If we don't have activity largest child yet, skip until the next measure pass
                    return;
                }
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            if (mIndicatorAnimator != null && mIndicatorAnimator.isRunning()) {
                // If we're currently running an animation, lets cancel it and start activity
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (targetView == null) {
                // If we don't have activity view, just update the position now and return
                updateIndicatorPosition();
                return;
            }
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setInterpolator(AnimationUtils.DEFAULT);
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mSelectedIndicatorWidth > 0 && mMinTabWidth >= mSelectedIndicatorWidth) {
                    if (mViewPager == null || !mIsDragged || right == 0) {
        ...
        private int getWrapContentIndicatorWidth(int index) {
            ...
            switch (mIndicatorMode) {
                ...
                case 1:
                    ...
                    if (textView != null) {
                        width = textView.getMeasuredWidth() + 2 * mIndicatorWidthExtra;
                    } else {
        ...
        public void setIndicatorWidthExtra(int extra) {
            if (mIndicatorWidthExtra != extra) {
                mIndicatorWidthExtra = extra;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
    }
    ...
    private int getTabMinWidth() {
        if (mRequestedTabMinWidth != INVALID_WIDTH) {
            // If we have been given activity min width, use it
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        ...
        // We return the default layout params so that we don't blow up if we're given activity TabItem
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            if (tabLayout != null) {
                ...
                // from activity setCurrentItem() call and will be handled by an animation from
    ...
    public void setIndicatorMode(int mode) {
        mTabStrip.setIndicatorMode(mode);
    }
    ...
    public void setIndicatorWidthExtra(int extra) {
        mTabStrip.setIndicatorWidthExtra(extra);
    }
}
