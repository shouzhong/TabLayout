...
/**
 * TabItem is activity special 'view' which allows you to declare tab items for activity {@link TabLayout}
 * within activity layout. This view is not actually added to TabLayout, it is just activity dummy which allows
 * setting of activity tab items's text, icon and custom layout. See TabLayout for more information on how
 * to use it.
 *
